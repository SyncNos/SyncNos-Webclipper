...
| WebClipper 改动 | [modules/webclipper.md](modules/webclipper.md), `AGENTS.webclipper.md` | 先理解运行时边界，再判断属于 background / content / popup / app 哪一层 |
...
| 6 | 若 WebClipper 改动涉及设置结构、视觉 tokens、主题切换、Inpage 阅读风格 / anti-hotlink 或 comments / detail UI，同时同步 `AGENTS.webclipper.md`、`src/ui/AGENTS.md` 与 `modules/comments.md` | 避免执行文档和 UI 设计文档继续沿用旧规则 |
...
| 改动影响 README、产品说明或 UI 设计原则 | 同步更新 `README.md` / `README.zh-CN.md` / `src/ui/AGENTS.md` | 避免用户文档、执行文档、设计文档各讲各的；若涉及 Inpage 设置或规则，优先让 `InpageSection.tsx` / `AntiHotlinkDomainsEditor.tsx` 作为真源 |
