...
| WebClipper 改动           | [modules/webclipper.md](modules/webclipper.md), `AGENTS.md`                                | 先理解运行时边界，再判断属于 background / content / popup / app 哪一层 |
...
| 6    | 若 WebClipper 改动涉及设置结构、视觉 tokens、主题切换、Inpage 阅读风格 / anti-hotlink 或 comments / detail UI，同时同步 `AGENTS.md`、`src/ui/AGENTS.md` 与 `modules/comments.md` | 避免执行文档和 UI 设计文档继续沿用旧规则        |
