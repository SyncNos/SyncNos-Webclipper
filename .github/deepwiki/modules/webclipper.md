...
- `src/collectors/gemini/gemini-collector.ts`
- `src/collectors/kimi/kimi-collector.ts`
- `src/collectors/zai/zai-collector.ts`
- `src/collectors/googleaistudio/googleaistudio-collector.ts`
- `src/collectors/web/article-fetch.ts`
- `src/collectors/web/article-fetch-background-handlers.ts`
- `src/collectors/web/article-extract/engine.ts`
- `src/collectors/web/article-extract/defuddle.ts`
- `src/collectors/web/article-extract/markdown-turndown.ts`
- `src/collectors/web/article-extract/html-clean.ts`
- `src/collectors/web/article-extract/site-spec-extractor.ts`
- `src/collectors/web/article-extract/sites/discourse.ts`
- `src/collectors/web/article-extract/sites/wechat.ts`
- `src/collectors/web/article-extract/sites/xiaohongshu.ts`
- `src/collectors/web/article-fetch-sites/index.ts`
- `src/collectors/web/article-fetch-sites/bilibili-opus.ts`
- `src/collectors/web/article-fetch-sites/xiaohongshu-note.ts`
- `src/platform/webext/anti-hotlink-rules-store.ts`
- `src/platform/webext/image-download-proxy.ts`
...
- `src/services/conversations/client/repo.ts`
...
- `src/services/integrations/item-mention/content/mention-controller.ts`
- `src/services/integrations/item-mention/content/mention-sites.ts`
- `src/services/integrations/detail-header-actions.ts`
...
- `src/ui/settings/sections/InpageSection.tsx`
- `src/ui/settings/sections/AntiHotlinkDomainsEditor.tsx`
- `src/ui/settings/SettingsSidebarNav.tsx`
- `src/viewmodels/settings/types.ts`
- `src/ui/settings/sections/ChatWithAiSection.tsx`
- `src/ui/settings/sections/InsightSection.tsx`
- `src/ui/settings/sections/InsightPanel.tsx`
- `src/viewmodels/settings/insight-stats.ts`
- `src/ui/styles/tokens.css`
- `src/ui/shared/MenuPopover.tsx`
- `src/ui/shared/SelectMenu.tsx`
- `src/ui/app/AppShell.tsx`
- `src/ui/app/CapturedListSidebar.tsx`
...
- `src/ui/popup/usePopupCurrentPageCapture.ts`
- `tests/smoke/background-router-current-page-capture.test.ts`
- `tests/smoke/article-extract-discourse-op-onebox-regression.test.ts`
- `tests/smoke/article-extract-markdown-complex.test.ts`
- `tests/smoke/article-extract-wechat-gallery.test.ts`
- `tests/smoke/article-extract-xiaohongshu-note.test.ts`
- `tests/smoke/article-extract-bilibili-opus.test.ts`
- `tests/smoke/article-fetch-service.test.ts`
- `tests/unit/article-extract-xiaohongshu.test.ts`
...
- `tests/domains/backup-service.test.ts`
- `tests/domains/backup-article-comments.test.ts`
- `tests/storage/insight-stats.test.ts`
- `tests/unit/settings-sections.test.ts`
- `tests/unit/item-mention-search.test.ts`
- `tests/smoke/background-router-item-mention.test.ts`
