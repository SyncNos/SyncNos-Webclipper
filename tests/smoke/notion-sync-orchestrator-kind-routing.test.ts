  ...
  it('routes chat/article to different dbSpec and avoids AI for article', async () => {
    ...
    const storage = {
      ...
      getArticleCommentsByConversationId: async (conversationId: number) => {
        ...
        return [
          { id: 1, parentId: null, conversationId: 1, canonicalUrl: 'https://a/', authorName: null, locator: null, createdAt: 1, updatedAt: 1, quoteText: 'q', commentText: 'root' },
          { id: 2, parentId: 1, conversationId: 1, canonicalUrl: 'https://a/', authorName: null, locator: null, createdAt: 2, updatedAt: 2, quoteText: '', commentText: 'reply' },
        ];
      },
