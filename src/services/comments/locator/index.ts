...
export { resolveV1CommentAnchor, normalizeV1CommentAnchorText } from '@services/comments/locator/resolve-v1-comment-anchor';
...
export function restoreRangeFromArticleCommentLocator(input: { root: Element; locator: ArticleCommentLocator }): Range | null {
